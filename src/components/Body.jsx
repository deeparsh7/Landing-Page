  ...
  return (
    <div className="space-y-4 lg:flex">
      <div className="flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end"> 
        <img src="./assets/Blue-Shape.svg" alt="lst" className="-rotate-[45deg] h-64 md:h-72 lg:h-[400px] " />
      ...
      <div className="lg:flex-1 lg:order-1">
        ...
        <form action="" className="flex flex-col gap-4 md:flex-row">
          <input className= "rounded-md px-4 py-4 placeholder:text-gray-500 " type="email" placeholder="Enter email address" />
          <button className="rounded-md px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white">Join Waitlist</button>
        </form>
        <div className="flex gap-2">
          <img src="./assets/Checkmark.svg" alt="Check" />
          <p className="font-lato text-gray-400 px-2 py-2 ">No spam, ever, Unsubscribe anytime</p>
        </div>
      </div>
    </div>
  );
